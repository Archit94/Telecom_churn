...
## Data Dictionary:
The dataset can be download using this [link](https://drive.google.com/file/d/1SWnADIda31mVFevFcfkGtcgBHTKKI94J/view?usp=sharing). The data dictionary is provided for download.
...
This is one of the most important parts of data preparation since good features are often the differentiators between good and bad models. Use our business understanding to derive features we think could be important indicators of churn.
...
## Modelling:
The predictive model that we’re going to build will serve two purposes:
...
Also, since the rate of churn is typically low (about 5-10%, this is called class-imbalance) - we try using techniques to handle class imbalance. 
